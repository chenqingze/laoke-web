...
export class DbService {
    ...
    readonly createTableSqlStatements: string [] = [
        // todo:完善需要创建的表 sql,这里写了个测试
            ...
            `CREATE TABLE IF NOT EXISTS msg_hist(seq NUMBER(32),id VARCHAR,conversationType VARCHAR,receiverId VARCHAR,conversationId VARCHAR,senderId NUMBER ,`
            + `msgDirection VARCHAR,msgType NUMBER,msgStatus NUMBER,content VARCHAR,createdAt NUMBER(32),updatedAt NUMBER(32),revokeAt NUMBER(32))`,
